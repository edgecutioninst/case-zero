...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-black text-slate-300 font-mono flex flex-col items-center justify-center p-8 selection:bg-cyan-900 selection:text-cyan-100 relative overflow-hidden">
      ...
      <div className="max-w-7xl w-full min-h-[600px] bg-[#030303] border border-slate-800 rounded-lg shadow-2xl shadow-black/80 flex flex-col md:flex-row overflow-hidden relative z-10">
        ...
        <div className="w-full md:w-1/2 relative border-b md:border-b-0 md:border-r border-slate-800 flex flex-col justify-between p-12 bg-black">
          ...
          <div className="relative z-10 mt-8">
            <p className="text-red-600 font-bold tracking-[0.3em] text-sm mb-3 [text-shadow:_0_0_10px_rgb(239_68_68_/_60%)]">
              [ TOP SECRET // NOFORN ]
            </p>
            ...
            <div className="h-[2px] w-1/3 bg-slate-800 mb-6"></div>
          </div>
        ...
        <div className="w-full md:w-1/2 p-12 flex flex-col items-center justify-center bg-[#050505] relative">
          ...
          <div className="w-full max-w-md flex flex-col items-center">
            ...
            <p className="text-slate-500 text-sm text-center mb-10 leading-relaxed [text-shadow:_0_0_8px_rgb(100_116_139_/_30%)]">
