    ...
    <div className="w-1/3 flex flex-col gap-4">
      ...
      <div className="flex-1 border border-slate-900 bg-[#050505] rounded-lg p-5 flex flex-col justify-center relative overflow-hidden group">
        ...
        <button 
          ...
          className="w-full py-6 bg-slate-900/40 hover:bg-slate-800 text-cyan-500 hover:text-cyan-400 font-bold tracking-widest text-lg border border-slate-700 rounded transition-all shadow-md group-hover:shadow-cyan-900/20 group-hover:border-cyan-800"
        >
          [ OPEN INVENTORY ]
        </button>
      </div>
